...
$cfg['blowfish_secret']					= '8uP[L8Msu8;XXUW?$a,XE4K,5<Yx=-<W' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= 'https://www.interlifemel.link/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_xNy7ZVzDpc2udqIihlT9weU/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://www.interlifemel.link/wp-admin/?rand=57146584&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://www.interlifemel.link/wp-admin/?rand=90290235&pma_logout=1';
