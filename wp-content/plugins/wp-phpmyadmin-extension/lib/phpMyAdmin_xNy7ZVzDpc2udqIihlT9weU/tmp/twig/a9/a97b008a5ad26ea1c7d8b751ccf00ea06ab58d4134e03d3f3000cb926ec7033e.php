...
class __TwigTemplate_644907dd38aae67e647c9dc198a601158bdff95535cda6ea2eef00d4e87fa5dd extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "/bitnami/wordpress/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_xNy7ZVzDpc2udqIihlT9weU/templates/database/export/index.twig");
    }
}
