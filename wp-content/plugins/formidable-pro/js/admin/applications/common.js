...
( function() {
	...
	function getCreateApplicationButton() {
		return a({
			className: 'button-primary frm-button-primary frm-new-application-button',
	...
	function addApplicationItemOption( container, { optionData, handleCheckboxChange }) {
		...
		checkbox.addEventListener(
			...
			event => {
				...
				option.classList.toggle( 'frm-selected-item-option', checkbox.checked );
			}
		);

		const checkboxLabel = tag( 'label', text );
		checkboxLabel.setAttribute( 'for', checkbox.id );

		const option = div({
			className: 'frm-application-item-option',
