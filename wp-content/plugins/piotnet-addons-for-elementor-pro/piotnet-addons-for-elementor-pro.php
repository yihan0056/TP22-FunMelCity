...
final class Piotnet_Addons_For_Elementor_Pro {
	...
	public function enqueue_styles_widget() {
		...
		wp_register_style( 'pafe-select2-style', plugin_dir_url( __FILE__ ) . 'assets/css/select2.css', [], PAFE_PRO_VERSION );
	}
