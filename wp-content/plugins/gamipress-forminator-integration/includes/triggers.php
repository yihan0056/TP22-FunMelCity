...
function gamipress_forminator_activity_triggers( $triggers ) {
    ...
    $triggers[__( 'Forminator', 'gamipress-forminator-integration' )] = array(
        // Form
        'gamipress_forminator_form_submission'                      => __( 'Successful submit a form', 'gamipress-forminator-integration' ),
        'gamipress_forminator_specific_form_submission'             => __( 'Successful submit a specific form', 'gamipress-forminator-integration' ),
        'gamipress_forminator_form_field_value_submission'          => __( 'Submit a specific field value on any form', 'gamipress-forminator-integration' ),
        'gamipress_forminator_specific_form_field_value_submission' => __( 'Submit a specific field value on a specific form', 'gamipress-forminator-integration' ),
        // Quiz
        'gamipress_forminator_quiz_submission'          => __( 'Successful submit a quiz', 'gamipress-forminator-integration' ),
        'gamipress_forminator_specific_quiz_submission' => __( 'Successful submit a specific quiz', 'gamipress-forminator-integration' ),

        'gamipress_forminator_pass_quiz'                => __( 'Pass a quiz', 'gamipress-forminator-integration' ),
        'gamipress_forminator_pass_specific_quiz'       => __( 'Pass a specific quiz', 'gamipress-forminator-integration' ),

        'gamipress_forminator_fail_quiz'                => __( 'Fail a quiz', 'gamipress-forminator-integration' ),
        'gamipress_forminator_fail_specific_quiz'       => __( 'Fail a specific quiz', 'gamipress-forminator-integration' ),

        'gamipress_forminator_quiz_field_value_submission'          => __( 'Submit a specific field value on any quiz', 'gamipress-forminator-integration' ),
        'gamipress_forminator_specific_quiz_field_value_submission' => __( 'Submit a specific field value on a specific quiz', 'gamipress-forminator-integration' ),
        // Poll
        'gamipress_forminator_poll_submission'          => __( 'Successful vote on a poll', 'gamipress-forminator-integration' ),
        'gamipress_forminator_specific_poll_submission' => __( 'Successful vote on a specific poll', 'gamipress-forminator-integration' ),
        'gamipress_forminator_poll_field_value_submission'          => __( 'Submit a specific field value on any poll', 'gamipress-forminator-integration' ),
        'gamipress_forminator_specific_poll_field_value_submission' => __( 'Submit a specific field value on a specific poll', 'gamipress-forminator-integration' ),
    );
...
function gamipress_forminator_activity_trigger_label( $title, $requirement_id, $requirement ) {
    ...
    switch( $requirement['trigger_type'] ) {
        ...
        case 'gamipress_forminator_form_field_value_submission':
            return sprintf( __( 'Submit a form setting field "%s" to "%s" value', 'gamipress-forminator-integration' ), $field_name, $field_value );
            break;
        ...
        case 'gamipress_forminator_specific_form_field_value_submission':
            ...
            return sprintf( __( 'Submit %s form setting field "%s" to "%s" value', 'gamipress-forminator-integration' ), $form_title, $field_name, $field_value );
            break;
        // Specific field value on any quiz
        case 'gamipress_forminator_quiz_field_value_submission':
            return sprintf( __( 'Submit a quiz setting field "%s" to "%s" value', 'gamipress-forminator-integration' ), $field_name, $field_value );
            break;
        ...
        case 'gamipress_forminator_specific_quiz_field_value_submission':
            ...
            return sprintf( __( 'Submit %s quiz setting field "%s" to "%s" value', 'gamipress-forminator-integration' ), $quiz_title, $field_name, $field_value );
            break;
        // Specific field value on any poll
        case 'gamipress_forminator_poll_field_value_submission':
            return sprintf( __( 'Submit a poll setting field "%s" to "%s" value', 'gamipress-forminator-integration' ), $field_name, $field_value );
            break;
        ...
        case 'gamipress_forminator_specific_poll_field_value_submission':
            ...
            return sprintf( __( 'Submit %s poll setting field "%s" to "%s" value', 'gamipress-forminator-integration' ), $poll_title, $field_name, $field_value );
            break;
    }
...
function gamipress_forminator_specific_activity_trigger_label( $specific_activity_trigger_labels ) {
    ...
    $specific_activity_trigger_labels['gamipress_forminator_specific_form_submission'] = __( 'Submit %s form', 'gamipress-forminator-integration' );
    $specific_activity_trigger_labels['gamipress_forminator_specific_form_field_value_submission'] = __( 'Submit a specific field value on %s form', 'gamipress-forminator-integration' );

    $specific_activity_trigger_labels['gamipress_forminator_specific_quiz_submission'] = __( 'Submit %s quiz', 'gamipress-forminator-integration' );
    $specific_activity_trigger_labels['gamipress_forminator_pass_specific_quiz'] = __( 'Pass %s quiz', 'gamipress-forminator-integration' );
    $specific_activity_trigger_labels['gamipress_forminator_fail_specific_quiz'] = __( 'Fail %s quiz', 'gamipress-forminator-integration' );
    $specific_activity_trigger_labels['gamipress_forminator_specific_quiz_field_value_submission'] = __( 'Submit a specific field value on %s quiz', 'gamipress-forminator-integration' );

    $specific_activity_trigger_labels['gamipress_forminator_specific_poll_submission'] = __( 'Vote on %s poll', 'gamipress-forminator-integration' );
    $specific_activity_trigger_labels['gamipress_forminator_specific_poll_field_value_submission'] = __( 'Submit a specific field value on %s poll', 'gamipress-forminator-integration' );
...
function gamipress_forminator_log_extra_data_fields( $fields, $log_id, $type ) {
    ...
    switch( $trigger ) {
        ...
        case 'gamipress_forminator_specific_poll_field_value_submission':
            ...
            $fields[] = array(
                'name'      => __( 'Field name', 'gamipress-forminator-integration' ),
                'desc'      => __( 'Field name attached to this log.', 'gamipress-forminator-integration' ),
                'id'        => $prefix . 'field_name',
                'type'      => 'text',
            );
            $fields[] = array(
                'name'      => __( 'Field value', 'gamipress-forminator-integration' ),
                'desc'      => __( 'Field value attached to this log.', 'gamipress-forminator-integration' ),
