...
function gamipress_forminator_requirement_ui_fields( $requirement_id, $post_id ) {
    ...
    <span class="forminator-field-name"><input type="text" value="<?php echo $field_name; ?>" placeholder="<?php echo __( 'Field name', 'gamipress-forminator-integration' ); ?>" /></span>
    <span class="forminator-field-value"><input type="text" value="<?php echo $field_value; ?>" placeholder="<?php echo __( 'Field value', 'gamipress-forminator-integration' ); ?>" /></span>
