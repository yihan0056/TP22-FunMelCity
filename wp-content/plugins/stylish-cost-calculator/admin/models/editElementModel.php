...
class Stylish_Cost_Calculator_Edit_Page {
        ...
        <div class="scc-content" style="display: none;">
            <div class="scc-transition px-0 advanced-option-wrapper">
                <?php if ($el->type == "custom math") : ?>
                        <div>
                            <label class="scc-accordion_switch_button">
                                <input onchange="changeDisplayFrontend(this)" class="scc_mandatory_dropdown" type="checkbox" <?php if ($el->displayFrontend == "1")  echo "checked" ?>>
                        ...
                        <div>
                            <label class="scc-accordion_switch_button">
                                <input onchange="changeDisplayDetail(this)" class="scc_mandatory_dropdown" type="checkbox" <?php if ($el->displayDetailList == "1")  echo "checked" ?>>
                                <span class="scc-accordion_toggle_button round"></span>
                            </label>
                        ...
                        <div>
                            <label class="scc-accordion_switch_button">
                                <input onchange="changeCalculationSymbol(this)" class="scc_mandatory_dropdown" type="checkbox" <?php if ($el->value3 == "1")  echo "checked" ?>>
                                <span class="scc-accordion_toggle_button round"></span>
                            </label>
                ...
                ?>
                    ...
                    <div class="image-button-border" style="<?php if( $el->value1 != 8) echo 'display:none' ?>">
                        <label class="scc-accordion_switch_button">
                            <input onchange="changeValue4(this)" class="scc_show_border" name="scc_mandatory_dropdown" type="checkbox" <?php if ($el->value4 == "true")  echo "checked" ?>>
                            <span class="scc-accordion_toggle_button round"></span>
                        </label>
                    ...
                    <?php if ( $el->value1 == 8 ): ?>
                        ...
                        <div class="buttonsqtn">
                            <label class="scc-accordion_switch_button">
                                <input onchange="changeValue3__(this)" class="scc_mandatory_dropdown" name="scc_mandatory_dropdown" type="checkbox" <?php if($el->value3 == 'true') echo 'checked' ?>>
                                <span class="scc-accordion_toggle_button round"></span>
                    ...
                    <label class="scc-accordion_switch_button">
                        <input onchange="changeMandatoryElement(this)" class="scc_mandatory_dropdown" name="scc_mandatory_dropdown" type="checkbox" <?php if ($el->mandatory == "1")  echo "checked" ?>>
                        <span class="scc-accordion_toggle_button round"></span>
                    </label>
                    <span>
                        <span class="scc-adv-opt-lbl use-tooltip" title="By activating this option, users are forced to select an option before being able to proceed to an email quote or view the detailed list">Mandatory</span>
                        <i class="material-icons-outlined more-settings-info t-img"  data-toggle="tooltip" title='<img src="<?php echo esc_url_raw(SCC_ASSETS_URL . '/images/tooltip-images/mandatory-element.png') ?>"></img>'>visibility</i>
                    </span>
                    <?php endif;
                    if ( in_array( $el->type, ["quantity box"] ) ) : 
                        ...
                        <div class="scc-accordion-tooltip px-0" style="width: 100%; text-align:left;">
                            ...
                            <!-- <div class="text-scc-col d-flex tooltipadmin-right">
                                <div class="col-md-3" style="padding:1px;">
                                    <label class="use-tooltip" title="You can limit the maximum number">Max number</label>
                                </div>
                                <div class="col-md-3" style="padding:1px;">
                                    <input onchange="changeValue3(this)" onkeyup="changeValue3(this)" class="scc_title_column_dskp" name="scc_title_column_dskp" type="number" value="<?php echo intval($el->value3) ?>">
                                </div>
                            </div>
                            <div class="text-scc-col d-flex">
                                <div class="col-md-3" style="padding:1px;">
                                    <label class="use-tooltip" title="You can set a minimum number.">Min number</label>
                                </div>
                                <div class="col-md-3" style="padding:1px;">
                                    <input onchange="changeValue4(this)" onkeyup="changeValue4(this)" class="scc_title_column_mobl" name="scc_title_column_mobl" type="number" value="<?php echo intval($el->value4) ?>">
                                </div>
                            </div> -->
                        </div>
                        <?php endif;
                ...
                <div>
                    <label class="scc-accordion_switch_button use-premium-tooltip" data-tooltip-image="<?php echo esc_url( SCC_TOOLTIP_BASEURL . '/price-hint.png' ) ?>">
                    ...
                    <span><span class="scc-adv-opt-lbl">Show Price Hint</span></span>
                </div>
                <?php endif; ?>
                <?php if ( in_array( $el->type, ["slider", "texthtml"] ) ): ?>
                <div>
                    <label class="scc-accordion_switch_button">
                        <input onchange="toggleSliderDisplayinDetail(this)" name="scc_hide_slider_on_detailed_view" type="checkbox" <?php if ($el->displayDetailList != "3")  echo "checked" ?>>
                        <span class="scc-accordion_toggle_button round"></span>
                    </label>
                    <span><span class="scc-adv-opt-lbl">Show on Detailed List</span></span>
                </div>
                <?php endif; ?>
                <?php if ( in_array( $el->type, ["slider"] ) ): ?>
                <div>
                    <label class="scc-accordion_switch_button">
                        <input onchange="toggleSliderInputBoxShowHide(this)" name="scc_show_inputbox_slider" type="checkbox" <?php if ($el->showInputBoxSlider != "0")  echo "checked" ?>>
                        <span class="scc-accordion_toggle_button round"></span>
                    </label>
                    <span><span class="scc-adv-opt-lbl">Add Input Box To Slider</span></span>
                </div>
               ...
               <?php endif; ?>
                ...
                <div>
                    <label class="scc-accordion_switch_button">
                        <input onchange="changeShowTitlePdf(this)" class="scc_mandatory_dropdown" name="scc_mandatory_dropdown" type="checkbox" <?php if ($el->showTitlePdf == "1")  echo "checked" ?>>
                        <span class="scc-accordion_toggle_button round"></span>
                    </label>
                    <span>Show Title on Detailed List & PDF<i class="material-icons-outlined more-settings-info t-img" data-toggle="tooltip" title='<img src="<?php echo esc_url_raw(SCC_ASSETS_URL . '/images/tooltip-images/show-title-pdf.png') ?>"></img>'>visibility</i></span>
                </div>
                <?php endif; 
                if($el->type != 'checkbox') : ?>
                    <div class="text-scc-col d-flex" style="font-size:13px;">
                        <!-- <div class="col-md-3" style="padding:1px;">
                            <label class="use-tooltip" title="Show tooltip next to title of element">Tooltip</label>
                        </div>
                        <div class="col-md-6 tool-premium" style="padding:1px;">
                            <input onchange="changeTooltipText(this)" onkeyup="changeTooltipText(this)" class="scc_title_column_mobl" name="scc_title_column_mobl" type="text" value="" disabled>
                        </div> -->
                        <div class="col-md-12 input-field use-premium-tooltip">
                            <input onchange="changeTooltipText(this)" onkeyup="changeTooltipText(this)" id="<?php echo esc_attr( 'scc_tooltip_input-' . $el->id ) ?>" class="scc_title_column_mobl" name="scc_title_column_mobl" type="text" value="<?php echo esc_attr($el->tooltiptext) ?>" disabled>
                            <label class="form-label fw-bold use-tooltip <?php echo strlen($el->tooltiptext) > 0 ? 'active' : ''; ?> " for="<?php echo esc_attr( 'scc_tooltip_input-' . $el->id ) ?>" title="On the frontend, display a tooltip icon and information next to element titles. Explain what this item is about while keeping the calculator form organized.">Tooltip</label>
                        </div>
                    </div>
                    <?php endif; 
                ?>
                <?php if ( $el->type !== 'texthtml' ): ?>
                <div class="scc-accordion-tooltip px-0" style="width: 100%; text-align:left;"><span style="text-align: left;display: block;font-weight:bold;">Responsive Options</span>
                    <div class="row gx-2 mt-2">
                ...
                <div class="scc-accordion-tooltip px-0" style="width: 100%; text-align:left;">
                    ...
                    <div class="row gx-0">
                            <label for="" style="font-weight:normal">Columns</label>
                        <select onchange="changeColumnsCheckbox(this)" name="" id="">
                            <option value="1" <?php if($el->value2 == '1') echo 'selected' ?> >One</option>
                            <option value="2" <?php if($el->value2 == '2') echo 'selected' ?> >Two</option>
                            <option value="3" <?php if($el->value2 == '3') echo 'selected' ?> >Three</option>
                        </select>
                    </div>
                </div>
                <?php endif; ?>
	...
	public function renderFileUploadSetupBody2($el, $conditionsBySet)
    {
        ...
        $defaults = [
            ...
            "elementitems" => array((object) array(
        ...
        <div class="scc-element-content" value="selectoption" style="<?php if (!$this->is_from_ajax) {
            echo "display:none;";
        } ?> height:auto;">
    ...
    public function renderCheckboxSetupBody( $el, $conditionsBySet )
    {
        ...
        ob_start();
        ?>
    <div class="scc-element-content checkbox-content" value="selectoption" style="<?php if (!$this->is_from_ajax) echo "display:none;" ?> height:auto">
        <!-- CONTENIDO DE CADA ELEMENTO -->
        ...
        <div class="scc-element-content" value="selectoption" style="<?php if (!$this->is_from_ajax) echo "display:none;" ?> height:auto">
        <div class="scc-new-accordion-container">
            <div class="styled-accordion">
                <div class="scc-title scc_accordion_advance" onclick="showAdvanceoptions(this)">
                    <i class="material-icons">keyboard_arrow_right</i><span>Advanced Options</span>
                                            ...
                                            <div class="col-xs-11 col-md-11" style="padding:0px;">
                                                <div class="conditional-selection-steps col-xs-12 col-md-12" style="padding:0px;">
                                                    <div class="item_conditionals">
                                                        ...
                                                        <select class="second-conditional-step col-3" style="height: 35px;">
                                                            <option value="0" style="font-size: 10px">Select one</option>
                                                            <option value="chec" <?php
                                                                                    if ($condition->op == 'chec') {
                                                                                        echo 'selected';
                                                                                    }
                                                                                    ?>>Checked</option>
                                                            <option value="unc" <?php
                                                                                if ($condition->op == 'unc') {
                                                                                    echo 'selected';
                                                                                }
                                                                                ?>>Unchecked</option>
        ...
        <div class="row m-0 selopt3 col-md-12 col-xs-12" style="margin-bottom:5px;padding:0px;width: 110%">
                    <div class="row" style="margin:0; padding: 0; width: 91%;">
                        <div class="row p-0 m-0 mt-2 col-md-12 col-xs-12">
                            ...
                            <div style="height: 39px;" class="123 el_1 col-xs-1 col-md-1 tool-premium  
                                                                            <?php
                                                                            if ($elit->opt_default == '1') {
                                                                                echo 'is-set-default';
                                                                            }
                                                                            ?>
                                                                            " onclick="setDefaultOption(this)" id="dropdownOpt" style="padding:0px;height:35px;";?>
                                <label class="scc-elm-num-lbl"><?php echo intval($count); ?></label>
                            </div>
                            <div class="col-md-6 col-xs-6 el_2" style="padding: 0px 5px 0px 1px;">
                                <input type="text" onkeyup="changeNameElementItem(this)" class="input_pad inputoption" style="width:100%;height:35px;" value="<?php echo stripslashes(wp_kses($elit->name, SCC_ALLOWTAGS)); ?>" placeholder="Product or service name">
                            </div>
                            <div class="col-md-3 d-flex" style="padding:0px; height: 39px;">
                        ...
                        <!-- < -->
                            ...
                            <?php if (isset($this->woo_commerce_products)) : ?>
                                <div class="dd-woocommerce <?php echo $is_image_checkbox ? 'scc-col-md-10' : 'scc-col-md-12'; if ( !empty($this->combine_checkout_woocommerce_product_id ) )  echo 'd-none' ?>" style="padding:0px;">
	...
	public function renderCommentBoxSetupBody2($el, $conditionsBySet)
    {
        ...
        <div class="scc-element-content" value="selectoption" style="<?php if (!$this->is_from_ajax) {
            ...
            <div class="slider-setup-body" style="border:0px none!">
                                                    ...
                                                    <div class="row m-0 mt-2 col-xs-12 col-md-12" style="padding: 0;margin-top: 5% !important;">
                                                    <label class="form-label fw-bold" style="width: 100%;padding: 0;">Placeholder</label>
															<div class="col-xs-12 col-md-12" style="padding:0px;">
																<textarea onkeyup="changeValue3(this)" class="input_pad inputoption_desc" style="height:35px;width:100%;max-width: 100%;" rows="1" placeholder=""><?php echo esc_attr( $el->value3 ); ?></textarea>
															</div>
														</div>
														</div>
                                                    <div class="scc-element-content" value="selectoption" style="display:none; height:auto">
        ...
        <div class="scc-element-content" value="selectoption" style="<?php if (!$this->is_from_ajax) echo "display:none;" ?> height:auto;">
            <div class="slider-setup-body">
                                                    ...
                                                    <div class="col-12 mb-3 edit-field">
                                                        ...
                                                        <select class="form-select w-100 pricing-structure-dd" onchange="changeValue1(this)">
                                                        ...
                                                        <i class="material-icons-outlined v-align-middle" data-element-tooltip-type="slider-type-<?php echo esc_attr($el->value1) ?>">info</i>
                                                    </div>
                                                    ...
                                                    <div class="row g-3 price-slider-item-header ">
                                                        ...
                                                        <?php foreach ($el->elementitems as $key => $item) {
                                                            $hide_range = false;
                                                            if ( in_array( $el->value1, array( "default", "quantity_mod" ) ) && $key > 0 ) $hide_range = true;
                                                                ?>
                                                            <div class="row g-3 price-slider-item <?php if ( $hide_range ) echo "d-none"; ?>">
                                                                <input type="text" class="id_element_slider_item" value="<?php echo $item->id ?>" hidden>
                                                                <div class="col">
                                                                    <input class="form-control" <?php if ($key > 0) echo "disabled" ?> onchange="changeElementItemValue1(this)" onkeyup="changeElementItemValue1(this)" type="number" min="0" value="<?php echo esc_attr($item->value1) ?>">
                                                                </div>
                                                                <div class="col">
                                                                    <input class="form-control" onchange="changeSliderToNumber(this),changeElementItemValue2(this)" onkeyup="changeSliderToNumber(this),changeElementItemValue2(this)" value="<?php echo esc_attr($item->value2) ?>" type="number" min="1">
                                                                </div>
                                                                <div class="col d-inline-flex">
                                                                    ...
                                                                    <input class="form-control" onchange="changeElementItemValue3(this)" onkeyup="changeElementItemValue3(this)" type="number" min="0" <?php if ($key === 0 && $el->value1 == "quantity_mod") echo 'disabled' ?> value="<?php echo esc_attr($item->value3) ?>">
                                                                </div>
                                                                <i onclick="deleteSliderItem(this)" class="material-icons-outlined range-close-btn" <?php if ($key === 0) echo 'disabled style="opacity: 0"' ?>>close</i>
                                                            </div>
                                                        <?php } ?>
                                                    <div class="text-start <?php if ( in_array( $el->value1, array( 'quantity_mod', 'default' ) ) ) echo 'd-none' ?>">
                                                        <p href="#" onclick="addNewRangeSlider(this)" class="link-primary text-decoration-none" role="button">+ Add Price Range</p>
                                                    </div>
                                                    </div>
                                                    <!-- ADVANCE -->
                                                    <div class="scc-new-accordion-container">
                                                                ...
                                                                <div class="scc-transition">
                                                                    ...
                                                                    // echo json_encode($conditionsBySet);
                                                                     foreach ($conditionsBySet as $key => $conditionCollection):
                                                                        ...
                                                                        <?php endif; ?>
                                                                        <div class="condition-container clearfix" data-condition-set=<?php echo intval($key) ?>>
                                                                            <?php foreach ($conditionCollection as $index => $condition) {
                                                                                if (($condition->op == "eq" || $condition->op == "ne" || $condition->op == "any") && !($condition->element_condition->type == "slider" || $condition->element_condition->type == "quantity box")) {
                                                                                    ?>
                                                                                    <div class="row col-xs-12 col-md-12 conditional-selection" style="padding: 0px; margin-bottom: 5px;">
                                                                                        <input type="text" class="id_conditional_item" value="<?php echo intval($condition->id) ?>" hidden>
                                                                                        ...
                                                                                        <div class="col-xs-11 col-md-11" style="padding:0px;">
                                                                                            <div class="conditional-selection-steps col-xs-12 col-md-12" style="padding:0px;">
                                                                                                <div class="item_conditionals">
                                                                                                    ...
                                                                                                    <select  class="second-conditional-step col-3" style="height: 35px;">
                                                                                                        <option value="0" style="font-size: 10px">Select one</option>
                                                                                                        <option value="eq" <?php if ($condition->op == "eq") echo 'selected' ?>>Equal To</option>
                                                                                                        <option value="ne" <?php if ($condition->op == "ne") echo 'selected' ?>>Not Equal To</option>
                                                                                                        <option value="any" <?php if ($condition->op == "any") echo 'selected' ?>>Any</option>
                                                                                                    </select>
                                                                                                    <select  class="third-conditional-step col-3" style="height: 35px;<?php if($condition->op== "any") echo 'display:none' ?> ">
                                                                                                        <option value="0" style="font-size: 10px">Select one</option>
                                                                                                        <option value="<?php echo intval($condition->elementitem_id) ?>" selected><?php echo esc_attr($condition->elementitem_name->name) ?></option>
                                                                                                    </select>
                                                                                                    <input value="<?php echo esc_attr($condition->value) ?>" type="number" placeholder="Number" style="height: 35px;display:none" class="conditional-number-value col-3" min="0">
                                                                                        ...
                                                                                        <div class="col-xs-11 col-md-11" style="padding:0px;">
                                                                                            <div class="conditional-selection-steps col-xs-12 col-md-12" style="padding:0px;">
                                                                                                <div class="item_conditionals">
                                                                                                    ...
                                                                                                    <select class="second-conditional-step col-3" style="height: 35px;">
                                                                                                        <option value="0" style="font-size: 10px">Select one</option>
                                                                                                        <option value="chec" <?php if($condition->op == "chec") echo 'selected' ?>>Checked</option>
                                                                                                        <option value="unc" <?php if($condition->op == "unc") echo 'selected' ?>>Unchecked</option>
                                                                                                    </select>
                                                                                                    <select  class="third-conditional-step col-3" style="height: 35px;display:none">
                                                                                                        <option value="0" style="font-size: 10px">Select one</option>
                                                                                                        <option value="<?php echo intval($condition->elementitem_id) ?>" selected><?php echo esc_attr($condition->elementitem_name->name) ?></option>
                                                                                                ...
                                                                                                <div class="conditional-selection-steps col-xs-12 col-md-12" style="padding:0px;">
                                                                                                    <div class="item_conditionals">
                                                                                                        ...
                                                                                                        <option value="0" style="font-size: 10px">Select one</option>
                                                                                                            <option value="eq" <?php if ($condition->op == "eq") echo 'selected'?>>Equal To</option>
                                                                                                            <option value="ne" <?php if ($condition->op == "ne") echo 'selected'?>>Not Equal To</option>
                                                                                                            <option value="gr" <?php if ($condition->op == "gr") echo 'selected'?>>Greater than</option>
                                                                                                            <option value="les" <?php if ($condition->op == "les") echo 'selected'?>>Less than</option>
                                                                                                        </select>
                                                                                                        <select  class="third-conditional-step col-3" style="height: 35px;display:none">
                                                                                                            <option value="0" style="font-size: 10px">Select one</option>
                                                                                                            <option value="<?php echo intval($condition->elementitem_id) ?>" selected><?php echo esc_attr($condition->elementitem_name->name) ?></option>
                                                                            ...
                                                                            <!-- <div style="background-color: black;height:50px"></div> -->
                                                                            <div class="row col-xs-12 col-md-12 conditional-selection  <?php if (count($conditionCollection)) echo "hidden" ?>" style="padding: 0px; margin-bottom: 5px;">
                                                                                <div class="col-xs-1 col-md-1" style="padding:0px;height:35px;background: #DCF1FD;">
                                                                                    <span class="scc_label" style="text-align:right;padding-right:10px;margin-top:5px;"><?php echo empty(count($el->conditions)) ? "Show if" : "And" ?></span>
                                                                                </div>
                                                                                <div class="col-xs-11 col-md-11" style="padding:0px;">
                                                                            ...
                                                                            <button onclick="(($this) => {jQuery($this).prev().removeClass('hidden'); jQuery($this).addClass('hidden')})(this)" class="btn btn-addcondition cond-add-btn <?php if (empty(count($el->conditions))) echo "hidden" ?>">+ AND</button>
                                                                        </div>
                                                                    <?php endforeach; ?>
                                                                    <div style="width: 28%">
                                                                        <button class="btn btn-primary btn-cond-or <?php echo empty(count($el->conditions)) ? "hidden" : "" ?>">+ OR</button>
    ...
    public function renderDropdownSetupBody($el, $conditionsBySet, $woo_commerce_products = null)
    {
        ...
        ob_start();
        ?>
        <div class="scc-element-content dropdown-content" value="selectoption" style="<?php if (!$this->is_from_ajax) echo "display:none;" ?> height:auto">
            <!-- CONTENIDO DE CADA ELEMENTO -->
            <!-- ELEMENT -->
            <div class="slider-setup-body">
            <label class="form-label fw-bold">Title</label>
    ...
    public function element_setup_part_dropdown_item($key, $elit)
    {
        ...
        <div class="row m-0 selopt3 col-md-12 col-xs-12" style="margin-top:10px;padding:0px">
            <div class="row p-0 m-0 col-md-11 col-xs-11">
                ...
                <div class="col-xs-2 col-md-2 tooltipadmin-left <?php if ($elit->opt_default == "1") echo "is-set-default" ?>" onclick="setDefaultOption(this)" id="dropdownOpt" <?php echo ($elit->opt_default == "1") ? ' data-selected="true"' : 'style="padding:0px;height:35px;" data-tooltip="Click to make this option default."'; ?>>
                ...
                <input type="text" onkeyup="changeNameElementItem(this)" class="input_pad inputoption" style="width:100%;height:40px;" value="<?php echo esc_html( $elit->name ); ?>" placeholder="Product or service name">
                </div>
                <div class="col-md-2 col-xs-2 d-flex" style="padding:0px">
                    <span class="input-group-text"><?php echo df_scc_get_currency_symbol_by_currency_code($this->df_scc_form_currency) ?></span>
                    <input type="number" onchange="changePriceElementItem(this)" onkeyup="changePriceElementItem(this)" class="input_pad inputoption_2" style="width:100%;text-align:center;height:40px;" placeholder="Price" value="<?php echo floatval( $elit->price ); ?>">
                </div>
    ...
    public function element_setup_part_dropdown_item_beta($key, $elit)
    {
        ...
        <div class="dd-item-field-container" data-element-item-id="<?php echo intval($elit->id) ?>">
            <div class="row g-3 dd-item-edit-field">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" onkeyup="changeNameElementItem(this, true)" value="<?php echo stripslashes(wp_kses($elit->name, SCC_ALLOWTAGS)) ?>">
                </div>
