...
class elementController {
	...
	function create( array $values ) {
		...
		( isset( $values['titleColumnDesktop'] ) ) ? $titleColumnDesktop = $values['titleColumnDesktop'] : $titleColumnDesktop = '';
		( isset( $values['titleColumnMobile'] ) ) ? $titleColumnMobile   = $values['titleColumnMobile'] : $titleColumnMobile = '';
	...
	function update( array $values ) {
		...
		$query    = $this->db->prepare(
			"UPDATE {$this->db->prefix}df_scc_elements SET orden =%s,titleElement=%s,`type`=%s,value1=%s,value2=%s,value3=%s,value4=%s,`length`=%s,uniqueId=%s,mandatory=%d,titleColumnDesktop=%s, 
