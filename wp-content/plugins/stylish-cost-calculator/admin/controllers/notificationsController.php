...
class SCC_Notifications {
    ...
    public function __construct( $type, $data )
    {
        ...
        // return $this->remote_notifications;
    }
    ...
    public function process_diag_msg($data)
    {
        ...
        // update_option( 'df_scc_notifications', $notif );
        return $notif;
    }
    public function output() {
        ...
        // $notifications = array_merge( $notifications['events'], $notifications['feed'] );
        ...
        <div class="row px-3 mt-5 scc-no-gutter" style="">
			<div class="card p-0 scc-notifications-wrapper">
				...
				<div class="card-body" id="scc-notifications">
					<a class="scc-dismiss" title="Dismiss this message"><i class="fa fa-times-circle" aria-hidden="true"></i></a>
