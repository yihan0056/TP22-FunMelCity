...
wp_localize_script( 'scc-backend', 'pageAllCalculators', array( 'nonce' => wp_create_nonce( 'all-calculators-page' ) ) );
?>
<div class="row">
	<div class="scc_title_bar" >EDIT ITEM LISTS</div>
</div>
<div class="row ms-1">
	<div class="row col-md-12 scc_container_forms">
		<!-- EACH ELEMENT -->
		...
		foreach ( $forms as $f ) {
			...
			?>
			<div id="scc_calculator_<?php echo intval( $f->id ); ?>" class="m-3 p-4 col-md-5" style="text-align: center;margin-top: 30px;background-color:#fff; margin:30px;padding:30px;border-radius:10px" >
				...
				<a class="opt-secondary" href="<?php echo esc_url(admin_url( "admin.php?page=quotes_with_id&id={$f->id}" )); ?>">View Quotes</a>
				<?php endif; ?>
				<a id="downloadAnchorElem"></a>
				<!-- <a style="padding-left:60px;" class="crossnadd" onClick="deleteSCC(45)" href="javascript:void(0)">  Delete  </a>
				<a style="padding-left:60px;" class="crossnadd" onClick="createDuplicate(45)" href="javascript:void(0)">  Duplicate </a></p> -->
				...
				jQuery.ajax({
					...
					success: function(data) {
						...
						if (response.passed == true) {
							...
							checkNoCalculator()
							showSweet(true, "The calculator was deleted")
						} else {
