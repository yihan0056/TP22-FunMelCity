...
wp_localize_script( 'scc-backend', 'notificationsNonce', array( 'nonce' => wp_create_nonce( 'notifications-box' ) ) );
	...
	<div class="row">
		<div class="col-md-3">
			<a href="https://stylishcostcalculator.com/" class="scc-footer logo">
				<img src="<?php echo esc_url( SCC_URL . 'assets/images/scc-logo.png' ); ?>" class="img-responsive1" style="padding-bottom:20px;max-width: 160px" alt="Image">
			</a>
		</div>
		<div class="col-md-3">
			<ul class="list-group">
		...
		<div class="col-md-3">
            <p>Do you like this plugin?<br/>We have <a href="#">many more</a> 😍</p>
