...
$stripeConfig                 = (get_option('df_scc_stripe_keys') == '') ? array(
	'pubKey'  => null,
	'privKey' => null,
...
$woocommerce_products_array = array();
	...
	foreach ($woo_commerce_products as $product) {
		if ($product->is_type('variable')) {
			...
			foreach ($available_variations as $product_variable) {
				...
				array_push($woocommerce_products_array, array(esc_html($product_variable['variation_id']) => esc_html(implode(' | ', $attributes)) . ' | Price: ' . get_woocommerce_currency_symbol() . '' . esc_html($product_variable['display_regular_price'])));
			}
		} else {
			array_push($woocommerce_products_array, array(esc_html($product->get_id()) => esc_html($product->get_name()) . ' | Price: ' . get_woocommerce_currency_symbol() . '' . esc_html($product->get_price())));
		}
	}
}
wp_localize_script('scc-backend', 'pageEditCalculator', array('nonce' => wp_create_nonce('edit-calculator-page')));
...
<div class="row ms-2 mt-4 scc-no-gutter">
	...
	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-7 left-pane">
		<!-- SECTION -->
		<div id="allinputstoadd" class="scc-col-xs-6 scc-col-lg-12 scc-col-md-12" style="width:100% !important; padding-left:0px !important;">
			<?php
			foreach ($f1->sections as $section) {
			?>
				<div class="addedFieldsStyle" style="display:grid;" id="Sccvo_0">
					...
					<div id="title54-bar-btns">
						<button id="settings-btn" class="btnn material-icons" href="javascript:void(0)" onclick="settingsIconShow(this)" style="line-height: 40px; float: right; margin-left: 20px; margin-right: 10px;">settings</button>
						<div class="scc-accordion-container scc-accordion-tooltip-hidden" style="display:inline-block;width: 50%">
							<div class="scc-accordion-tooltip-left-arrow" style="top: -22px;"></div>
							<div class="scc-accordion-tooltip scc-accordion-content">
								<button onclick="settingsIconHide(this)" class="scc-accordion-btn-close"></button>
								<!-- SETTINGS TOOGLE -->
								<p>
									<label class="scc-accordion_switch_button">
										<input class="scc_accordion_section" onchange="changeAccordion(this)" name="scc_accordion_section" type="checkbox" <?php
								...
								<p class="section-total-on-pdf-container" style="display : <?php echo esc_attr($section->showSectionTotal) == 'true' ? 'inline' : 'none'; ?>">
									<label class="scc-accordion_switch_button use-premium-tooltip">
										<input disabled onchange="changeShowSectionTotalOnPdf(this)" name="scc-section-total-on-pdf" type="checkbox" <?php
						...
						<button id="close-btn" class="btnn material-icons" href="javascript:void(0)" onclick="preDeletionDialog('section', removeSection, this)" style="line-height: 34px;width: 39px">close</button>
						<button id="down-btn" class="btnn material-icons down" title="Push this section below" style="display: block; line-height: 34px; width: 39px;" href="javascript:void(0)" onclick="rdown(this)">arrow_drop_down</button>
						<button id="up-btn" class="btnn material-icons up" title="Push this section above" style="display: none; line-height: 34px;width: 39px;" href="javascript:void(0)" onclick="rup(this)">arrow_drop_up</button>
					</div>
					<!-- TITLE -->
					...
					<div class="description_section_no_edit_container" style="">
						...
						<div class="scc-col-md-10" style="padding:0px" onclick="toggleEditDescription(this)">
							<i class="fa fa-pen text-primary"></i>
							<p style="margin-top:2px; font-size: 14px" class="description_section_no_edit d-inline">
					...
					<div class="fieldDatatoAdd">
						...
						?>
							<div class="boardOption">
								...
								<div class="scc_subsection">
									<button id="close-btn" class="collapsible" href="javascript:void(0)" onclick="preDeletionDialog('subsection', removeSubsection, this)" style="float:right; font-size:20px;">x</button>
									<button class="collapsible subsect-title">Subsection </button>
									<div class="scc_help_btn_right" style="left:26px;float:right;top:23px;font-size:18px;"><a href="#" style="padding-left:10px;color:black;" class="tooltipadmin-right" data-tooltip="Use subsections to control which elements a slider has an effect on. Note: You can only add one slider per subsection.">
											<img src="<?php echo esc_url(SCC_URL . '/assets/images/info-icon-scc.png'); ?>" alt="Info Icon" height="15px;"> </a></div>
								</div>
									...
									?>
										...
										for ($i = 0; $i < count($el->conditions); $i++) {
											...
											if (!in_array($tmpConditionSet, array_keys($conditionsBySet))) {
												$conditionsBySet += array($tmpConditionSet => array($el->conditions[$i]));
											} else {
											...
											<div class="elements_added">
												...
												<div class="elements_added_v2">
													...
													<div class="element-action-icons">
														<i class="material-icons-outlined" onclick="javascript:collapseElement(this)" style="cursor: pointer;font-size: 18px;">expand_more</i>
														<i class="material-icons-outlined with-tooltip" data-element-tooltip-type="dropdown">info</i>
														<i class="material-icons-outlined with-tooltip" onclick="javascript:handleElementCopy(this)" title="Copy this element" style="cursor: pointer;font-size: 18px;">content_copy</i>
														<i class="sortable_subsection_element material-icons-outlined with-tooltip" title="Move this element" style="cursor: pointer;font-size: 18px;">open_with</i>
														<i class="material-icons-outlined with-tooltip" onclick="preDeletionDialog('element', removeElement, this)" title="Deletes this element" style="cursor: pointer;font-size: 18px;">delete</i>
													</div>
												</div>
										...
										?>
											<div class="elements_added">
												...
												<div class="elements_added_v2">
													...
													<div class="element-action-icons">
														<i class="material-icons-outlined" onclick="javascript:collapseElement(this)" style="cursor: pointer;font-size: 18px;">expand_more</i>
														<i class="material-icons-outlined with-tooltip" data-element-tooltip-type="<?php echo esc_attr($tooltip_type); ?>" title="<?php echo esc_attr($typeDescription); ?>">info</i>
														<i class="material-icons-outlined with-tooltip" onclick="javascript:handleElementCopy(this)" title="Copy this element" style="cursor: pointer;font-size: 18px;">content_copy</i>
														<i class="sortable_subsection_element material-icons-outlined with-tooltip" title="Move this element" style="cursor: pointer;font-size: 18px;">open_with</i>
														<i class="material-icons-outlined with-tooltip" onclick="preDeletionDialog('element', removeElement, this)" title="Deletes this element" style="cursor: pointer;font-size: 18px;">delete</i>
													</div>
										...
										?>
											<div class="elements_added">
												...
												<div class="elements_added_v2">
													...
													<div class="element-action-icons">
														<i class="material-icons-outlined" onclick="javascript:collapseElement(this)" style="cursor: pointer;font-size: 18px;">expand_more</i>
														<i class="material-icons-outlined with-tooltip" data-element-tooltip-type="comment-box" title="Shows an textarea on the frontend, where user can type out the comment">info</i>
														<i class="material-icons-outlined with-tooltip" onclick="javascript:handleElementCopy(this)" title="Copy this element" style="cursor: pointer;font-size: 18px;">content_copy</i>
														<i class="sortable_subsection_element material-icons-outlined with-tooltip" title="Move this element" style="cursor: pointer;font-size: 18px;">open_with</i>
														<i class="material-icons-outlined with-tooltip" onclick="preDeletionDialog('element', removeElement, this)" title="Deletes this element" style="cursor: pointer;font-size: 18px;">delete</i>
													</div>
										...
										if ($el->type == 'quantity box') {
											...
											<div class="elements_added">
												...
												<div class="elements_added_v2">
													...
													<div class="element-action-icons">
														<i class="material-icons-outlined" onclick="javascript:collapseElement(this)" style="cursor: pointer;font-size: 18px;">expand_more</i>
														<i class="material-icons-outlined with-tooltip" data-element-tooltip-type="quantity-input-box">info</i>
														<i class="material-icons-outlined with-tooltip" onclick="javascript:handleElementCopy(this)" title="Copy this element" style="cursor: pointer;font-size: 18px;">content_copy</i>
														<i class="sortable_subsection_element material-icons-outlined with-tooltip" title="Move this element" style="cursor: pointer;font-size: 18px;">open_with</i>
														<i class="material-icons-outlined with-tooltip" onclick="preDeletionDialog('element', removeElement, this)" title="Deletes this element" style="cursor: pointer;font-size: 18px;">delete</i>
													</div>
										...
										?>
											<div class="elements_added">
												...
												<div class="elements_added_v2">
													...
													<div class="element-action-icons">
														<i class="material-icons-outlined" onclick="javascript:collapseElement(this)" style="cursor: pointer;font-size: 18px;">expand_more</i>
														<i class="material-icons-outlined with-tooltip" data-element-tooltip-type="custom-math" title="Note: Custom Math applies extra calculation over the value returned by the elements in a subsection. E.g. If the subsection returns 100, and the custom math is 10%, the final value of the subsection will be 110. You can use to decrease the subsection total using negative sign to the value, for example, -10%">info</i>
														<i class="material-icons-outlined with-tooltip" onclick="javascript:handleElementCopy(this)" title="Copy this element" style="cursor: pointer;font-size: 18px;">content_copy</i>
														<i class="sortable_subsection_element material-icons-outlined with-tooltip" title="Move this element" style="cursor: pointer;font-size: 18px;">open_with</i>
														<i class="material-icons-outlined with-tooltip" onclick="preDeletionDialog('element', removeElement, this)" title="Deletes this element" style="cursor: pointer;font-size: 18px;">delete</i>
													</div>
												...
												<div class="scc-element-content" value="selectoption" style="display:none; height:auto">
													...
													<div class="edit-element-notice" style="margin-left: 15px;">
														<i class="material-icons with-tooltip" title="Note: Custom Math applies extra calculation over the value returned by the elements in a subsection. E.g. If the subsection returns 100, and the custom math is 10%, the final value of the subsection will be 110. You can use to decrease the subsection total using negative sign to the value, for example, -10%">info</i>
													</div>
													<!-- ELEMENT -->
													...
													<div class="scc-new-accordion-container">
														...
														<div class="styled-accordion">
															<div class="scc-title scc_accordion_conditional use-tooltip-child-nodes">
																<i class="material-icons">keyboard_arrow_right</i><span>Conditional Logic</span>
															</div>
										...
										if ($el->type == 'file upload') {
											...
											<div class="elements_added">
												...
												<div class="elements_added_v2">
													...
													<div class="element-action-icons">
														<i class="material-icons-outlined" onclick="javascript:collapseElement(this)" style="cursor: pointer;font-size: 18px;">expand_more</i>
														<i class="material-icons-outlined with-tooltip" data-element-tooltip-type="file-upload">info</i>
														<i class="material-icons-outlined with-tooltip" onclick="javascript:handleElementCopy(this)" title="Copy this element" style="cursor: pointer;font-size: 18px;">content_copy</i>
														<i class="sortable_subsection_element material-icons-outlined with-tooltip" title="Move this element" style="cursor: pointer;font-size: 18px;">open_with</i>
														<i class="material-icons-outlined with-tooltip" onclick="preDeletionDialog('element', removeElement, this)" title="Deletes this element" style="cursor: pointer;font-size: 18px;">delete</i>
													</div>
										...
										?>
											<div class="elements_added">
												...
												<div class="elements_added_v2">
													...
													<div class="element-action-icons">
														<i class="material-icons-outlined" onclick="javascript:collapseElement(this)" style="cursor: pointer;font-size: 18px;">expand_more</i>
														<i class="material-icons-outlined with-tooltip" data-element-tooltip-type="text-html-field" title="You can add custom HTML code inside this element">info</i>
														<i class="material-icons-outlined with-tooltip" onclick="javascript:handleElementCopy(this)" title="Copy this element" style="cursor: pointer;font-size: 18px;">content_copy</i>
														<i class="sortable_subsection_element material-icons-outlined with-tooltip" title="Move this element" style="cursor: pointer;font-size: 18px;">open_with</i>
														<i class="material-icons-outlined with-tooltip" onclick="preDeletionDialog('element', removeElement, this)" title="Deletes this element" style="cursor: pointer;font-size: 18px;">delete</i>
													</div>
										...
										?>
											<div class="elements_added">
												...
												<div class="elements_added_v2">
													...
													<div class="element-action-icons">
														<i class="material-icons-outlined" onclick="javascript:collapseElement(this)" style="cursor: pointer;font-size: 18px;">expand_more</i>
														<i class="material-icons-outlined with-tooltip" data-element-tooltip-type="slider-element">info</i>
														<i class="material-icons-outlined with-tooltip" onclick="javascript:handleElementCopy(this)" title="Copy this element" style="cursor: pointer;font-size: 18px;">content_copy</i>
														<i class="sortable_subsection_element material-icons-outlined with-tooltip" title="Move this element" style="cursor: pointer;font-size: 18px;">open_with</i>
														<i class="material-icons-outlined with-tooltip" onclick="preDeletionDialog('element', removeElement, this)" title="Deletes this element" style="cursor: pointer;font-size: 18px;">delete</i>
													</div>
								...
								<div class="df_scc_groupbuttonsadd scc-col-md-12 scc-col-xs-12" style="margin:15px; display:none ">
									<button value="dropdowninput" class="scc_button btn-backend" onclick="addDropdownMenuElement(this)"><i class="far fa-list-alt" style="padding-top:3px;"></i>
										<div class="btn-backend-text">DropDown</div>
									</button>
									<button value="switchinput" class="scc_button btn-backend" onclick="addCheckboxElement(this,1)"><i class="far fa-check-square" style="padding-top:3px;"></i>
									...
									<button value="switchinput" class="scc_button btn-backend" onclick="addCheckboxElement(this,6)"><i class="far fa-rectangle-wide" style="margin-top:5px;width:26px;height: 9px;background-color: white;"></i>
										<div class="btn-backend-text">Simple Button </div>
									</button>
									<button value="switchinput" class="scc_button btn-backend" onclick="addCheckboxElement(this,8)"><i class="fas fa-image" style=""></i>
										<div class="btn-backend-text">Image Button </div>
									</button>
									<button class="scc_button btn-backend" onclick="addSliderElement(this)"><i class="fas fa-sliders-h" style="padding-top:3px;"></i>
									...
									<button value="comment_input" class="scc_button btn-backend" onclick="addCommentBoxElement(this)"><i class="fas fa-comment" style="padding-top:3px;"></i>
										<div class="btn-backend-text">Comment Box</div>
									</button>
									<button value="number_input" class="scc_button btn-backend" onclick="addQuantityBox(this)"><i class="material-icons" style="padding-top:3px;">exposure</i>
										<div class="btn-backend-text">Quantity Box</div>
									</button>
									<button class="scc_button btn-backend" onclick="addCustomMath(this)"><i class="fas fa-calculator" style="padding-top:3px;"></i>
										<div class="btn-backend-text">Custom Math</div>
									</button>
									<button value="file_input" class="scc_button btn-backend" onclick="addFileUpload(this)"><i class="fas fa-paperclip" style="padding-top:3px;"></i>
										<div class="btn-backend-text">File Upload</div>
									</button>
									<button value="custom_code" class="scc_button btn-backend" onclick="addTextHtml(this)"><i class="fas fa-code" style="padding-top:3px;"></i>
										<div class="btn-backend-text">Text/HTML Field</div>
									</button>
									<button value="custom_code" class="scc_button btn-backend" onclick="addTextHtml(this)"><i class="fas fa-calculator" style="padding-top:3px;"></i>
										<div class="btn-backend-text">Variable Math</div>
									</button>
									<button value="custom_code" class="scc_button btn-backend" onclick="addTextHtml(this)"><i class="fas fa-calendar-alt" style="padding-top:3px;"></i>
...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		<?php
		if ((get_option('df-scc-save-count') == scc_feedback_invokation('form')) && scc_feedback_invokation('form') != 0) {
			echo "jQuery('#user-scc-sv').modal('show').show();";
		}
		?>
		...
		for (var i = 0; i < sortableContainers.length; i++) {
			...
			Sortable.create(sortableContainers[i].element, {
				group: 'nested',
				forceFallback: true,
				handle: '.sortable_subsection_element',
				animation: 150,
				ghostClass: "scc_sortable-ghosts", // Class name for the drop placeholder
				chosenClass: "scc_sortable-chosens", // Class name for the chosen item
				dragClass: "scc_sortable-drags", // Class name for the dragging item
	...
	function handleElementCopy(element, type = 1) {
		...
		// var popo = duplicatedDrop(clonedElement,["10","20","30","40"])
		...
		jQuery.ajax({
			...
			success: function(data) {
				...
				if (datajson.passed == true) {
					...
					element.find('.with-tooltip').add('.use-tooltip').each(function(index, node) {
	...
	function addNewRangeSlider(element) {
		...
		function newPriceRangeItem(previousNumber, idnewElement) {
			var item = '<div class="row col-xs-12 col-md-12 price-slider-item" style="">'
			item += '    <input type="text" class="id_element_slider_item" value="' + idnewElement + '" hidden>'
			item += '    <div class="col-xs-4 col-md-4"><input disabled onchange="changeElementItemValue1(this)" onkeyup="changeElementItemValue1(this)" disabled type="number" min="0" class="scc_label input_pad sliderinputoption scc_input" value="' + previousNumber + '" style="width:90PX;height:40px;margin-left:12px;padding:6px;"></div>'
			item += '    <div class="col-xs-4 col-md-4"><input onchange="changeSliderToNumber(this),changeElementItemValue2(this)" onkeyup="changeSliderToNumber(this),changeElementItemValue2(this)" type="number" min="0" class="scc_label  input_pad sliderinputoption_2 scc_input" value="' + (previousNumber + 1) + '" style="width:90PX;height:40px;margin-left:12px;padding:6px;"></div>'
			item += '    <div class="col-xs-4 col-md-4"><input onchange="changeElementItemValue3(this)" onkeyup="changeElementItemValue3(this)" type="number" min="0" class="scc_label  input_pad sliderinputoption_5 scc_input" value="2" style="width:90PX;height:40px;padding:6px;margin-left:-33px"><a style="cursor:pointer;padding-left:5px" onclick="deleteSliderItem(this)">X</a></div>'
			item += '</div>'
			var item2 = `<div class="row g-3 price-slider-item ">
                <input type="text" class="id_element_slider_item" value="${idnewElement}" hidden="">
                <div class="col">
                    <input class="form-control" disabled onchange="changeElementItemValue1(this)" onkeyup="changeElementItemValue1(this)" type="number" min="0" value="${previousNumber}">
                </div>
                <div class="col">
                    <input class="form-control" onchange="changeSliderToNumber(this),changeElementItemValue2(this)" onkeyup="changeSliderToNumber(this),changeElementItemValue2(this)" value="${ previousNumber + 1 }" type="number" min="0">
                </div>
                <div class="col">
                    <input class="form-control" onchange="changeElementItemValue3(this)" onkeyup="changeElementItemValue3(this)" type="number" min="0" value="2">
                </div>
		...
		jQuery.ajax({
			...
			success: function(data) {
				...
				if (datajson.passed == true) {
					...
					// applying tooltips
					element.find('[data-element-tooltip-type]').each((i, node) => {
						applyElementTooltip(node);
					})
					jQuery(element.find('.with-tooltip')).each((index, element) => {
	...
	var array = <?php echo isset($f1->formstored) ? json_encode($f1->formstored) : json_encode(array()); ?>;
	console.log(array);
	...
	function togglebuttonsadd(element) {
		var groupButtons = jQuery(element).closest('div').next('div');
		groupButtons.toggle();
	}
	...
	function settingsIconShow(settingsIcon) {
		jQuery(settingsIcon).next().removeClass('scc-accordion-tooltip-hidden')
	}
	/**
	 * *Hides section settings
	 */
	function settingsIconHide(settingsIcon) {
		jQuery(settingsIcon).parent().parent().parent().find('.scc-accordion-container').each(function(index, ob) {
			jQuery(ob).toggleClass('scc-accordion-tooltip-hidden scc-accordion-tooltip-hidden scc-accordion-tooltip-hidden')
		})
	}
	/**
	...
	function removeSection(section1) {
		...
		var section = jQuery(section1).parent().parent(".addedFieldsStyle");
	...
	function removeSubsection(element) {
		showLoadingChanges()
		var id_subsection = jQuery(element).parent().parent().find(".input_subsection_id").val();
		// its removing the fist subsection istead of the section corespondant
		var subsection = jQuery(element).parent().parent(".boardOption")
		jQuery.ajax({
			url: ajaxurl,
			cache: false,
			data: {
	...
	function insertSubSection(idsubsection) {
		...
		subs += '                                <div class="scc_subsection">'
		subs += '                                    <button id="close-btn" class="collapsible" href="javascript:void(0)" onclick="preDeletionDialog(\'subsection\', removeSubsection, this)" style="float:right; font-size:20px;">x</button>'
		subs += '                                    <button class="collapsible subsect-title">Subsection </button>'
		subs += '                                    <div class="scc_help_btn_right" style="left:26px;float:right;top:23px;font-size:18px;"><a href="#" style="padding-left:10px;color:black;" class="tooltipadmin-right" data-tooltip="Use subsections to control which elements a slider has an effect on. Note: You can only add one slider per subsection.">'
		subs += '                                            <img src="<?php echo esc_url(SCC_URL . '/assets/images/info-icon-scc.png'); ?>" alt="Info Icon" height="15px;"> </a></div>'
		subs += '                                </div>'
		subs += ''
		...
		subs += '                                      <button value="dropdowninput" class="scc_button btn-backend" onclick="addDropdownMenuElement(this)"><i class="far fa-list-alt" style="padding-top:3px;font-size:13px;"></i>'
		subs += '                                          <div class="btn-backend-text">DropDown</div>'
		subs += '                                      </button>'
		subs += '                                      <button value="switchinput" class="scc_button btn-backend" onclick="addCheckboxElement(this,1)"><i class="far fa-check-square" style="padding-top:3px;font-size:13px;"></i>'
		subs += '                                          <div class="btn-backend-text">Checkbox</div>'
		subs += '                                      </button>'
		subs += '                                      <button value="switchinput" class="scc_button btn-backend" onclick="addCheckboxElement(this,3)"><i class="fas fa-toggle-off" style="padding-top:3px;font-size:13px;"></i>'
		subs += '                                          <div class="btn-backend-text">Toggle Switch</div>'
		subs += '                                      </button>'
		subs += '                                      <button value="switchinput" class="scc_button btn-backend" onclick="addCheckboxElement(this,6)"><i class="far fa-rectangle-wide" style="margin-top:5px;font-size:13px;width:26px;height: 9px;background-color: white;"></i>'
		subs += '                                          <div class="btn-backend-text">Simple Button </div>'
		subs += '                                      </button>'
		subs += '                                    <button value="switchinput" class="scc_button btn-backend" onclick="addCheckboxElement(this,8)"><i class="fas fa-image" style="font-size:13px;"></i>'
		subs += '                                        <div class="btn-backend-text">Image Button </div>'
		subs += '                                    </button>'
		subs += '                                      <button class="scc_button btn-backend" onclick="addSliderElement(this)"><i class="fas fa-sliders-h" style="padding-top:3px;font-size:13px;"></i>'
		subs += '                                          <div class="btn-backend-text">Slider</div>'
		subs += '                                      </button>'
		subs += '                                      <input class="inputoption_slidchk" type="checkbox" onClick="addSlider(this)" style="display:none;" />'
		subs += '                                      <button value="comment_input" class="scc_button btn-backend" onclick="addCommentBoxElement(this)"><i class="fas fa-comment" style="padding-top:3px;font-size:13px;"></i>'
		subs += '                                          <div class="btn-backend-text">Comment Box</div>'
		subs += '                                      </button>'
		subs += '                                      <button value="number_input" class="scc_button btn-backend" onclick="addQuantityBox(this)"><i class="material-icons" style="padding-top:3px;font-size:13px;">exposure</i>'
		subs += '                                          <div class="btn-backend-text">Quantity Box</div>'
		subs += '                                      </button>'
		subs += '                                      <button class="scc_button btn-backend" onclick="addCustomMath(this)"><i class="fas fa-calculator" style="padding-top:3px;font-size:13px;"></i>'
		subs += '                                          <div class="btn-backend-text">Custom Math</div>'
		subs += '                                      </button>'
		subs += '                                      <button value="file_input" class="scc_button btn-backend" onclick="addFileUpload(this)"><i class="fas fa-paperclip" style="padding-top:3px;font-size:13px;"></i>'
		subs += '                                          <div class="btn-backend-text">File Upload</div>'
		subs += '                                      </button>'
		subs += '                                      <button value="custom_code" class="scc_button btn-backend" onclick="addTextHtml(this)"><i class="fas fa-code" style="padding-top:3px;font-size:13px;"></i>'
		subs += '                                          <div class="btn-backend-text">Text/HTML Field</div>'
		subs += '                                      </button>'
		subs += '										<button value="custom_code" class="scc_button btn-backend" onclick="addTextHtml(this)"><i class="fas fa-calculator" style="padding-top:3px;font-size:13px;"></i>'
		subs += '											<div class="btn-backend-text">Variable Math</div>'
		subs += '										</button>'
		subs += ' 										<button value="custom_code" class="scc_button btn-backend" onclick="addTextHtml(this)"><i class="fas fa-calendar-alt" style="padding-top:3px;font-size:13px;"></i>'
	...
	function insertSection(idsection, idsubsection) {
		...
		section += '                    <div id="title54-bar-btns">'
		section += '                        <button id="settings-btn" class="btnn material-icons" href="javascript:void(0)" onclick="settingsIconShow(this)" style="line-height: 40px; float: right; margin-left: 20px;">settings</button>'
		section += '                        <div class="scc-accordion-container scc-accordion-tooltip-hidden" style="display:inline-block;width: 50%">'
		section += '                            <div class="scc-accordion-tooltip-left-arrow" style="top: -22px;"></div>'
		section += '                            <div class="scc-accordion-tooltip scc-accordion-content">'
		section += '                                <button onclick="settingsIconHide(this)" class="scc-accordion-btn-close"></button>'
		...
		section += '                            </div>'
		section += '                        </div>'
		section += '                        <button id="close-btn" class="btnn material-icons" href="javascript:void(0)" onclick="preDeletionDialog(\'section\', removeSection, this)" style="line-height: 34px;width: 39px">close</button>'
		section += '                        <button id="down-btn" class="btnn material-icons down" title="Push this section below" style="display: block; line-height: 34px; width: 39px;" href="javascript:void(0)" onclick="rdown(this)">arrow_drop_down</button>'
		section += '                        <button id="up-btn" class="btnn material-icons up" title="Push this section above" style="display: none; line-height: 34px;width: 39px;" href="javascript:void(0)" onclick="rup(this)">arrow_drop_up</button>'
		section += '                    </div>'
		section += '                    <!-- TITLE -->'
		...
		section += '                            <i class="fa fa-pen text-primary" role="button"></i>'
		section += '                            <p style="margin-top:2px; font-size: 14px" class="description_section_no_edit d-inline">'
		...
		section += '                                <div class="scc_subsection">'
		section += '                                    <button id="close-btn" class="collapsible" href="javascript:void(0)" onclick="preDeletionDialog(\'subsection\', removeSubsection, this)" style="float:right; font-size:20px;">x</button>'
		section += '                                    <button class="collapsible subsect-title">Subsection </button>'
		section += '                                    <div class="scc_help_btn_right" style="left:26px;float:right;top:23px;font-size:18px;"><a href="#" style="padding-left:10px;color:black;" class="tooltipadmin-right" data-tooltip="Use subsections to control which elements a slider has an effect on. Note: You can only add one slider per subsection.">'
		section += '                                            <img src="<?php echo esc_url(SCC_URL . '/assets/images/info-icon-scc.png'); ?>" alt="Info Icon" height="15px;"> </a></div>'
		section += '                                </div>'
		...
		section += '                                    <button value="dropdowninput" class="scc_button btn-backend" onclick="addDropdownMenuElement(this)"><i class="far fa-list-alt" style="padding-top:3px;font-size:13px;"></i>'
		section += '                                        <div class="btn-backend-text">DropDown</div>'
		section += '                                    </button>'
		section += '                                    <button value="switchinput" class="scc_button btn-backend" onclick="addCheckboxElement(this,1)"><i class="far fa-check-square" style="padding-top:3px;font-size:13px;"></i>'
		section += '                                        <div class="btn-backend-text">Checkbox</div>'
		section += '                                    </button>'
		section += '                                    <button value="switchinput" class="scc_button btn-backend" onclick="addCheckboxElement(this,3)"><i class="fas fa-toggle-off" style="padding-top:3px;font-size:13px;"></i>'
		section += '                                        <div class="btn-backend-text">Toggle Switch</div>'
		section += '                                    </button>'
		section += '                                    <button value="switchinput" class="scc_button btn-backend" onclick="addCheckboxElement(this,6)"><i class="far fa-rectangle-wide" style="margin-top:5px;font-size:13px;width:26px;height: 9px;background-color: white;"></i>'
		section += '                                        <div class="btn-backend-text">Simple Button </div>'
		section += '                                    </button>'
		section += '                                    <button value="switchinput" class="scc_button btn-backend" onclick="addCheckboxElement(this,8)"><i class="fas fa-image" style="font-size:13px;"></i>'
		section += '                                        <div class="btn-backend-text">Image Button </div>'
		section += '                                    </button>'
		section += '                                    <button class="scc_button btn-backend" onclick="addSliderElement(this)"><i class="fas fa-sliders-h" style="padding-top:3px;font-size:13px;"></i>'
		...
		section += '                                    </button>'
		section += '                                    <button class="scc_button btn-backend" onclick="addCustomMath(this)"><i class="fas fa-calculator" style="padding-top:3px;font-size:13px;"></i>'
		section += '                                        <div class="btn-backend-text">Custom Math</div>'
		section += '                                    </button>'
		section += '                                    <button value="file_input" class="scc_button btn-backend" onclick="addFileUpload(this)"><i class="fas fa-paperclip" style="padding-top:3px;font-size:13px;"></i>'
		section += '                                        <div class="btn-backend-text">File Upload</div>'
		section += '                                    </button>'
		section += '                                    <button value="custom_code" class="scc_button btn-backend" onclick="addTextHtml(this)"><i class="fas fa-code" style="padding-top:3px;font-size:13px;"></i>'
		section += '                                        <div class="btn-backend-text">Text/HTML Field</div>'
		section += '                                    </button>'
		section += '										<button value="custom_code" class="scc_button btn-backend" onclick="addTextHtml(this)"><i class="fas fa-calculator" style="padding-top:3px;font-size:13px;"></i>'
		section += '											<div class="btn-backend-text">Variable Math</div>'
		section += '										</button>'
		section += ' 									<button value="custom_code" class="scc_button btn-backend" onclick="addTextHtml(this)"><i class="fas fa-calendar-alt" style="padding-top:3px;font-size:13px;"></i>'
	...
	function insertCheckboxElement(idElement, idElementitem, type, elementDOM) {
		...
		var elementHead = `<div class="elements_added_v2">
			...
			<div class="element-action-icons">
				<i class="material-icons-outlined" onclick="javascript:collapseElement(this)" style="cursor: pointer;font-size: 18px;">expand_less</i>
				<i class="material-icons-outlined with-tooltip" data-element-tooltip-type="${tooltip_type}">info</i>
				<i class="material-icons-outlined with-tooltip" onclick="javascript:handleElementCopy(this)" title="Copy this element" style="cursor: pointer;font-size: 18px;">content_copy</i>
				<i class="sortable_subsection_element material-icons-outlined with-tooltip" title="Move this element" style="cursor: pointer;font-size: 18px;">open_with</i>
				<i class="material-icons-outlined with-tooltip" onclick="preDeletionDialog(\'element\', removeElement, this)" title="Deletes this element" style="cursor: pointer;font-size: 18px;">delete</i>
			</div>
		...
		// element += '    <div class="scc-title scc_accordion_conditional" onclick="showConditionaLogic(this)">'
		// element += '        <i class="material-icons">keyboard_arrow_right</i><span>Conditional Logic</span>'
		// element += '    </div>'
	...
	function insertCustomMath(idnewElement) {
		var elementHead = `<div class="elements_added_v2">
			...
			<div class="element-action-icons">
				<i class="material-icons-outlined" onclick="javascript:collapseElement(this)" style="cursor: pointer;font-size: 18px;">expand_less</i>
				<i class="material-icons-outlined with-tooltip" title="Note: Custom Math applies extra calculation over the value returned by the elements in a subsection. E.g. If the subsection returns 100, and the custom math is 10%, the final value of the subsection will be 110. You can use to decrease the subsection total using negative sign to the value, for example, -10%">info</i>
				<i class="material-icons-outlined with-tooltip" onclick="javascript:handleElementCopy(this)" title="Copy this element" style="cursor: pointer;font-size: 18px;">content_copy</i>
				<i class="sortable_subsection_element material-icons-outlined with-tooltip" title="Move this element" style="cursor: pointer;font-size: 18px;">open_with</i>
				<i class="material-icons-outlined with-tooltip" onclick="preDeletionDialog('element', removeElement, this)" title="Deletes this element" style="cursor: pointer;font-size: 18px;">delete</i>
			</div>
		...
		element += '            <i class="material-icons with-tooltip" title="Note: Custom Math applies extra calculation over the value returned by the elements in a subsection. E.g. If the subsection returns 100, and the custom math is 10%, the final value of the subsection will be 110. You can use to decrease the subsection total using negative sign to the value, for example, -10%">info</i>'
		element += '        </div>'
		element += '        <!-- ELEMENT -->'
		...
		element += '</div>'
		element += '<div class="styled-accordion">'
		element += '    <div class="scc-title scc_accordion_conditional use-premium-tooltip">'
		element += '        <i class="material-icons">keyboard_arrow_right</i><span>Conditional Logic</span>'
		element += '    </div>'
		element += '    <div class="scc-content" style="display: none;">'
		element += '        <div class="scc-transition">'
	...
	function insertSliderElement(idnewElement, idnewElementItem, elementDOM) {
		var elementHead = `<div class="elements_added_v2">
			...
			<div class="element-action-icons">
				<i class="material-icons-outlined" onclick="javascript:collapseElement(this)" style="cursor: pointer;font-size: 18px;">expand_less</i>
				<i class="material-icons-outlined with-tooltip" title="Note: Sliders are linked to any elements in the same subsection. Example: If you select 10 units with the slider, it will add 10 units to any dropdown or checkbox element above it. If you want to unlink them, make sure the slider sits in its own subsection.">info</i>
				<i class="material-icons-outlined with-tooltip" onclick="javascript:handleElementCopy(this)" title="Copy this element" style="cursor: pointer;font-size: 18px;">content_copy</i>
				<i class="sortable_subsection_element material-icons-outlined with-tooltip" title="Move this element" style="cursor: pointer;font-size: 18px;">open_with</i>
				<i class="material-icons-outlined with-tooltip" onclick="preDeletionDialog('element', removeElement, this)" title="Deletes this element" style="cursor: pointer;font-size: 18px;">delete</i>
			</div>
	...
	function insertTextHtml(idnewElement) {
		var elementHead = `<div class="elements_added_v2">
			...
			<div class="element-action-icons">
				<i class="material-icons-outlined" onclick="javascript:collapseElement(this)" style="cursor: pointer;font-size: 18px;">expand_less</i>
				<i class="material-icons-outlined with-tooltip" title="You can add custom HTML code inside this element">info</i>
				<i class="material-icons-outlined with-tooltip" onclick="javascript:handleElementCopy(this)" title="Copy this element" style="cursor: pointer;font-size: 18px;">content_copy</i>
				<i class="sortable_subsection_element material-icons-outlined with-tooltip" title="Move this element" style="cursor: pointer;font-size: 18px;">open_with</i>
				<i class="material-icons-outlined with-tooltip" onclick="preDeletionDialog('element', removeElement, this)" title="Deletes this element" style="cursor: pointer;font-size: 18px;">delete</i>
			</div>
		...
		element += '            </p>'
		element += '            <span style="text-align: left;display: block;"><b>Responsive Options</b></span>'
	...
	function insertFileupload(idnewElement) {
		var elementHead = `<div class="elements_added_v2">
			...
			<div class="element-action-icons">
				...
				<i class="material-icons-outlined with-tooltip" onclick="javascript:handleElementCopy(this)" title="Copy this element" style="cursor: pointer;font-size: 18px;">content_copy</i>
				<i class="sortable_subsection_element material-icons-outlined with-tooltip" title="Move this element" style="cursor: pointer;font-size: 18px;">open_with</i>
				<i class="material-icons-outlined with-tooltip" onclick="preDeletionDialog(\'element\', removeElement, this)" style="cursor: pointer;font-size: 18px;">delete</i>
			</div>
		</div>`
		var element = '<div class="elements_added" style="border: 2px solid rgb(138, 153, 248);border-style: dashed;">'
		element += '    <input type="text" class="input_id_element" value="' + idnewElement + '" hidden="">'
	...
	function insertQuantityBox(idnewElement, elementDOM) {
		var elementHead = `<div class="elements_added_v2">
			...
			<div class="element-action-icons">
				<i class="material-icons-outlined" onclick="javascript:collapseElement(this)" style="cursor: pointer;font-size: 18px;">expand_less</i>
				<i class="material-icons-outlined with-tooltip" title="Shows a input box where users can define the number of units">info</i>
				<i class="material-icons-outlined with-tooltip" onclick="javascript:handleElementCopy(this)" title="Copy this element" style="cursor: pointer;font-size: 18px;">content_copy</i>
				<i class="sortable_subsection_element material-icons-outlined with-tooltip" title="Move this element" style="cursor: pointer;font-size: 18px;">open_with</i>
				<i class="material-icons-outlined with-tooltip" onclick="preDeletionDialog('element', removeElement, this)" title="Deletes this element" style="cursor: pointer;font-size: 18px;">delete</i>
			</div>
	...
	function insertCommentBoxElement(idnewElement, elementDOM) {
		var elementHead = `<input type="text" class="input_id_element" value="${idnewElement}" hidden="">
			...
			<div class="element-action-icons">
				<i class="material-icons-outlined" onclick="javascript:collapseElement(this)" style="cursor: pointer;font-size: 18px;">expand_less</i>
				<i class="material-icons-outlined with-tooltip" title="Shows an textarea on the frontend, where user can type out the comment">info</i>
				<i class="material-icons-outlined with-tooltip" onclick="javascript:handleElementCopy(this)" title="Copy this element" style="cursor: pointer;font-size: 18px;">content_copy</i>
				<i class="sortable_subsection_element material-icons-outlined with-tooltip" title="Move this element" style="cursor: pointer;font-size: 18px;">open_with</i>
				<i class="material-icons-outlined with-tooltip" onclick="preDeletionDialog('element', removeElement, this)" title="Deletes this element" style="cursor: pointer;font-size: 18px;">delete</i>
			</div>
	...
	function insertDropdownElement(idElement, idElementitem, elementDOM) {
		...
		var elementHead = `<div class="elements_added_v2">
			...
			<div class="element-action-icons">
				<i class="material-icons-outlined" onclick="javascript:collapseElement(this)" style="cursor: pointer;font-size: 18px;">expand_less</i>
				<i class="material-icons-outlined with-tooltip" title="Shows a dropdown choice on the frontend">info</i>
				<i class="material-icons-outlined with-tooltip" onclick="javascript:handleElementCopy(this)" title="Copy this element" style="cursor: pointer;font-size: 18px;">content_copy</i>
				<i class="sortable_subsection_element material-icons-outlined with-tooltip" title="Move this element" style="cursor: pointer;font-size: 18px;">open_with</i>
				<i class="material-icons-outlined with-tooltip" onclick="preDeletionDialog('element', removeElement, this)" title="Deletes this element" style="cursor: pointer;font-size: 18px;">delete</i>
			</div>
